...
if inicio.login(credencial, senha) == (True, True):
    ...
    while opcao >= 1 and opcao <= 18:
        if opcao == 1:
            ...
            numero = int(input("Insira o número e curso da turma\n"))
            curso = input()
            listaturma.remove(numero, curso)
            listaturma.salvar_em_arquivo("turmas.json")
        elif opcao == 5:
            numero = int(input("Insira o número e o curso da turma\n"))
            curso = input()
            turma1 = listaturma.search(numero, curso)
            nome = input("Insira o nome e RA do aluno\n")
            ra = input()
            ...
            aluno.atividades.insert(nome, 0)
            listaturma.salvar_em_arquivo("turmas.json")
        elif opcao == 10:
            numero = int(input("Insira o número e o curso da turma\n"))
            curso = input()
            ...
            aluno = turma1.alunos.search(ra)
            nome = input("Insira o nome da atividade\n")
            atividade = aluno.atividades.search(nome)
            if atividade is not None:
                print("Atividade encontrada:")
                print(atividade.nome)
                print(atividade.nota)
            else:
            ...
            hinicio = input("Hora de início:\n")
            fim = input("Hora do fim:\n")
            professor = input("Nome do professor:\n")
            conteudo = input("Conteudo da aula:\n")
            turma1.aulas.insert(nome, data, hinicio, fim, curso, professor, conteudo)
            listaturma.salvar_em_arquivo("turmas.json")
        elif opcao == 15:    
            numero = int(input("Insira o número e o curso da turma\n"))
            curso = input()
            ...
            curso = input()
            turma1 = listaturma.search(numero, curso)
            nome = input("Insira o nome e a data da aula\n")
            data = input()
            turma1.aulas.remove(nome, data)
            listaturma.salvar_em_arquivo("turmas.json")
        elif opcao == 18:
